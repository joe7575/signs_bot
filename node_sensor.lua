...
local function update_infotext(pos, dest_pos, dest_idx)
	M(pos):set_string("infotext", I("Node Sensor: Connected with ")..dest_pos.." / "..dest_idx)
end	
...
minetest.register_node("signs_bot:node_sensor", {
	...
	after_place_node = function(pos, placer)
		...
		local node = minetest.get_node(pos)
		meta:set_int("param2", (node.param2 + 1) % 4)
	end,
...
minetest.register_lbm({
	...
	nodenames = {"signs_bot:node_sensor"},
